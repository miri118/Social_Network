...
namespace Service.Services
{
    public class FeedbackService : IService<FeedbackDto>
    {
        ...
        {
            return mapper.Map<Feedback, FeedbackDto>(repository.Add(mapper.Map<FeedbackDto, Feedback>(user)));
        }
        ...
        {
            return mapper.Map<List<Feedback>, List<FeedbackDto>>(repository.GetAll());
        }

        public FeedbackDto GetById(int id)
        {
            return mapper.Map<Feedback, FeedbackDto>(repository.GetById(id));
        }

        public void Update(int id, FeedbackDto item)
        {
            repository.Update(id, mapper.Map<FeedbackDto, Feedback>(item));
        }
    }
}

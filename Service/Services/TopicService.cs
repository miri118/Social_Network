...
namespace Service.Services
{
    public class TopicService : IService<TopicDto>
    {
        ...
        {
            return mapper.Map<Topic, TopicDto>(repository.Add(mapper.Map<TopicDto, Topic>(user)));
        }
        ...
        {
            return mapper.Map<List<Topic>, List<TopicDto>>(repository.GetAll());
        }

        public TopicDto GetById(int id)
        {
            return mapper.Map<Topic, TopicDto>(repository.GetById(id));
        }

        public void Update(int id, TopicDto item)
        {
            repository.Update(id, mapper.Map<TopicDto, Topic>(item));
        }
    }
}
